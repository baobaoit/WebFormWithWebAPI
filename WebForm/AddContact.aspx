...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="row">
        <asp:Label Text="Name:" CssClass="col-sm-6" runat="server"></asp:Label>
        <asp:TextBox runat="server" ID="txtName"></asp:TextBox><br />
        <asp:Label Text="Company:" CssClass="col-sm-6" runat="server"></asp:Label>
        <asp:TextBox runat="server" ID="txtCompany"></asp:TextBox><br />
        <asp:Label Text="Email:" CssClass="col-sm-6" runat="server"></asp:Label>
        <asp:TextBox runat="server" ID="txtEmail"></asp:TextBox><br />
        <asp:Label Text="Address:" CssClass="col-sm-6" runat="server"></asp:Label>
        <asp:TextBox runat="server" ID="txtAddress"></asp:TextBox><br />
        <asp:Label Text="" CssClass="col-sm-6" runat="server"></asp:Label>
        <button runat="server" class="btn btn-success" id="btnAdd" onserverclick="btnAdd_ServerClick">
